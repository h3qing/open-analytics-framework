...
|---|---|---|---|---|---|---|---|
| MX-01 | 1A | Segmentation | topic | — | drafted | Author's thesis, segmentation is where the manufacturing lens stops; Meta's ARPU sentence and Airbnb's ADR as mix moves; Netflix's US loss under global growth; Wheeler's rational subgrouping; Kohavi on post-hoc segments | 1 session |
