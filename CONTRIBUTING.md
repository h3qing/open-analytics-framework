...
Thank you for considering it. The most valuable contribution this project can receive is a substantive review of a single pattern — a comment that says "this failed for us because…" is worth more than praise for the whole framework.
...
Documentation contributions are accepted under CC BY 4.0; code and template contributions under MIT (see [LICENSE](LICENSE)). By submitting, you agree your contribution is licensed accordingly.
