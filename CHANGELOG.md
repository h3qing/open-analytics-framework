...
- Modules 3 and 4 now name their two halves — 3A what the agent can reach and 3B what it tells you; 4A what you must be able to show and 4B the money numbers themselves. Module 3 is ordered by whether the consequence can be reversed rather than the decision, and the Module 3 / Module 4 line is settled: Module 3 owns the run, Module 4 owns the record.
