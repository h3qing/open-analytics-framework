...
| Tag | Contents | Status |
|---|---|---|
| — | Repo public, skeleton, prior-art review, four charters | in progress |
| — | Diagnostic skill v0.1 published | not started |
| v0.1.0 | Opening module's (Module 1) core patterns publishable — 1B integrity patterns, on the 1A topic pages already drafted | not started |
| v0.2.0 | Module 1 complete, both halves (1A definition quality, 1B data integrity), first reference architecture | not started |
| v0.3.0 | Second module core patterns, first implementation guide, skill v1.0 | not started |
