...
5. **Route changes through the one place.** When a definition changes, the blessed view changes in one reviewed edit, and every consumer picks the change up without being touched. This is the payoff the platform companies describe, down to definition changes triggering their own backfills.[^chang-2021]
6. **Name the owner.** One person owns the registry and reviews edits to blessed views.
