...
**Status:** build order set. The first pattern, [the context file](context-file.md), is drafted with its template; nothing else is written yet. Statuses live in [CONTENT_BACKLOG.md](../../../CONTENT_BACKLOG.md).
...
| [Write your company's context file in an afternoon](../../../templates/03-ai-agent-integration/context-file.md) | You agree the file matters and never sit down to write it | template |
