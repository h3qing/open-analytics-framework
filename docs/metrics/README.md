...
| [Segmentation](segmentation.md) | drafted; sourced draft, author interview on the thesis pending |
...
Planned next: value retention and LTV, then cost and margin. Revenue and usage after those.
