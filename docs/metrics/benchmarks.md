...
**Set the goal where ambition meets belief.** A goal should feel ambitious and achievable at the same time, and the author's working rule is to set it at about 80 percent of what is achievable. The research backs both halves. Specific hard goals beat easy goals and "do your best", and performance rises with goal difficulty until the team runs out of ability or stops believing, across more than 100 tasks and 40,000 participants in the canonical summary [^locke-latham-2002]. The warning label is equally replicated: goals prescribed too aggressively narrow a team's focus and invite gaming of the number, the Goodhart failure the [attribution](attribution.md) page treats at length [^ordonez-2009].
...
Checking is cheap: a trace takes about an hour, and steering a quarter by a wrong number costs far more. The published benchmarks above can be walked back to their samples and funders. Many numbers that arrive in decks and blog posts are the other kind: good retention supposedly flattens near some level, and companies your size supposedly hire their first data person at some head count.
